...
// $(".v-code").each( function() {
//     this.prepend( "<div class=\"v-copy-container\"><button class=\"btn v-copy btn-light\"><i class=\"fa fa-clipboard\" aria-hidden=\"true\"></i>Copy</button></div>" );
//     if(this.style.height > 200) {
//         this.append( "<div class=\"v-copy-container\"><button class=\"btn v-copy btn-light\"><i class=\"fa fa-clipboard\" aria-hidden=\"true\"></i>Copy</button></div>" );
//     }
