...
-- Started on 2017-12-13 20:17:57
...
DROP DATABASE blog;
--
-- TOC entry 2873 (class 1262 OID 16459)
...
--
-- TOC entry 2874 (class 1262 OID 16459)
-- Dependencies: 2873
...
--
-- TOC entry 217 (class 1255 OID 16928)
-- Name: description(integer, text, text); Type: FUNCTION; Schema: public; Owner: postgres
--
...
ALTER FUNCTION public.description(chars integer, body text, short text) OWNER TO postgres;
...
--
-- TOC entry 248 (class 1255 OID 16898)
...
--
-- TOC entry 236 (class 1255 OID 16899)
...
--
-- TOC entry 2724 (class 2604 OID 16482)
...
--
-- TOC entry 2725 (class 2604 OID 16858)
...
--
-- TOC entry 2866 (class 0 OID 16471)
-- Dependencies: 199
...
--
-- TOC entry 2868 (class 0 OID 16847)
-- Dependencies: 201
...
--
-- TOC entry 2864 (class 0 OID 16460)
-- Dependencies: 197
...
--
-- TOC entry 2737 (class 2606 OID 16857)
...
--
-- TOC entry 2728 (class 2606 OID 16481)
-- Name: users_old users_pk_userid; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- TOC entry 2739 (class 2606 OID 16860)
...
--
-- TOC entry 2730 (class 2606 OID 16468)
-- Name: users_old users_unique_email; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- TOC entry 2732 (class 2606 OID 16466)
-- Name: users_old users_unique_username; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- TOC entry 2735 (class 1259 OID 16511)
...
--
-- TOC entry 2741 (class 2620 OID 16900)
...
--
-- TOC entry 2742 (class 2620 OID 16914)
-- Name: users trigger_blog_users_update2; Type: TRIGGER; Schema: public; Owner: postgres
--
...
--
-- TOC entry 2740 (class 2620 OID 16514)
...
-- Completed on 2017-12-13 20:17:58
